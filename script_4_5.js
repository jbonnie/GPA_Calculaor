...
let grades = [4.5, 4.0, 3.5, 3.0, 2.5, 2.0, 1.5, 1.0, 0.0];
...
document.getElementById('4.3').addEventListener('click', moving);
...
function print_result() {
    ...
    document.querySelector("#screen_major").value = "Total GPA\n\n" + Math.round(sum_total*100)/100 + " / 4.5\n\n";
    document.querySelector("#screen_major").value += Math.round(sum_total/4.5*4.3*100)/100 + " / 4.3";
    document.querySelector("#screen_non_major").value = "Major GPA\n\n" + Math.round(sum_major*100)/100 + " / 4.5\n\n";
    document.querySelector("#screen_non_major").value += Math.round(sum_major/4.5*4.3*100)/100 + " / 4.3";
}
function moving() {
    location.replace("4_3.html");
}
function home() {
